import re
from typing import Pattern, Final, Optional, cast, Type, Dict, Any

from sqlalchemy import inspect, Column, TIMESTAMP, func
from sqlalchemy.orm import declarative_base, declared_attr, has_inherited_table, declarative_mixin
from sqlalchemy.util import ImmutableProperties

# Регулярка розделяющая строку по заглавным буквам
...
class DatabaseModel(Base):
    ...
    def __tablename__(self) -> Optional[str]:
        """
        Автоматически генерирует имя таблицы из названия модели, пример:
